...
def convert_to_wav(audio_file):
    ...
    in .wav format. Returns a filepath to the .wav version.
    """

    #check if the audio file is a path or a bytearray
    if 'decode' in dir(audio_file):
        pass
        #TODO, handle the case where we just have a bytearray/blob
